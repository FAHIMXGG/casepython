        ...
        <div>
            ...
            <div className='mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12'>
                ...
                <div className='sm:col-span-12 md:col-span-9 text-base'>
                    <div className='grid grid-cols-1 gap-y-8 border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10'>
                        <div>
                        ...
                        <div className='bg-gray-50 p-6 sm:rounded-lg sm:p-8'>
                            <div className='flow-root text-sm' >
                                ...
                                {finish === 'textured' ? (<div className='flex items-center justify-between py-1 mt-2 '>
                                    ...
                                    <p className='font-medium text-gray-900'>{formatPrice(PRODUCT_PRICE.finish.textured / 100)}</p>
                                </div>) : null}
