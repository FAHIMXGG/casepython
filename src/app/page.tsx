          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              <div className="flex gap-0.5 mb-2">
                <Star className="h-5 w-5 text-[#E4335A] fill-[#E4335A]" />
                <Star className="h-5 w-5 text-[#E4335A] fill-[#E4335A]" />
                <Star className="h-5 w-5 text-[#E4335A] fill-[#E4335A]" />
                <Star className="h-5 w-5 text-[#E4335A] fill-[#E4335A]" />
                <Star className="h-5 w-5 text-[#E4335A] fill-[#E4335A]" />
              ...
              <div className="text-lg leading-8">
                <p>
                  &quot; The case feels durable and O even got a compliment on the design. Had the case for two and a half months now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love it. &quot;
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img src="/users/user-1.png" alt="user" className="rounded-full h-12 object-cover" />
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                <img src="/users/user-4.jpg" alt="user" className="rounded-full h-12 object-cover" />
                <div className="flex flex-col">
        ...
        <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center"  >
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                Upload your photo and get <span className="relative px-2 bg-red-600 text-white">your own case  </span> now
              </h2>
            </div>
          </div>
