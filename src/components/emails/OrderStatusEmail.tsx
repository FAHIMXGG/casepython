...
const STATUS_MESSAGE = {
  awaiting_shipment: "Your order is being processed",
  fulfilled: "Your order has been fulfilled and is being prepared for shipping",
...
const OrderStatusEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Order Status Update - CasePython</Preview>
      <Body style={main}>
        ...
        <Section style={message}>
          ...
          <Section style={global.defaultPadding}>
            ...
            <Text>Status: {STATUS_MESSAGE[orderStatus]}</Text>
          </Section>
          <Section style={global.defaultPadding}>
            <Text>
